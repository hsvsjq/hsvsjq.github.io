...
function customMainInit() {
	...
	setMainSpriteRotation(90)
	//lblFrame = document.getElementById('lblFrame')
}

function setMainSpriteRotation(rotation){
	mainSprite.style.transform = 'rotate(' + rotation + 'deg)';
	mainSpriteRotation = rotation
}
